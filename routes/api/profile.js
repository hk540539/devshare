...
router.get('/me', auth, async (req, res) => {
	try {
		// here user is a collection in DB with name,avatar,username,password,avatar,id as fields
...
router.post(
	...
	[
		auth,
		[ check('status', 'Status is required').not().isEmpty(), check('skills', 'Status is required').not().isEmpty() ]
	],
	async (req, res) => {
		...
		try {
			...
			//upsert update and insert if doesn't exists
...
router.delete('/experience/:exp_id', auth, async (req, res) => {
	try {
		...
		// Filter exprience array using _id (NOTE: _id is a JSON type needs to be converted to string)
